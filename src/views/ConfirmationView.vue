      ...
      <div class="confirmation-container">
        <div class="success-icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" fill="#d4af37"/>
          </svg>
        </div>
        ...
        <p class="message">
          ...
          <span v-if="registeredPhone">Vi sender information til <strong>{{ registeredPhone }}</strong></span>
          <span v-else>Af sikkerhedsmæssige årsager</span> vil du modtage en SMS med den præcise lokation få dage inden arrangementet.
        </p>
        ...
        <div class="reminder-box">
          ...
          <ul>
            ...
            <li>Din buy-in på <strong>50 DKK</strong> (kontant ved ankomst)</li>
        ...
        <div class="calendar-section">
          ...
          <button class="calendar-button" @click="addToCalendar">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16" height="16" style="margin-right: 8px">
              <path d="M128 0c17.7 0 32 14.3 32 32V64H288V32c0-17.7 14.3-32 32-32s32 14.3 32 32V64h48c26.5 0 48 21.5 48 48v48H0V112C0 85.5 21.5 64 48 64H96V32c0-17.7 14.3-32 32-32zM0 192H448V464c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V192zm64 80v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H80c-8.8 0-16 7.2-16 16zm128 0v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H208c-8.8 0-16 7.2-16 16zm144-16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16V272c0-8.8-7.2-16-16-16H336z" fill="currentColor"/>
            </svg>
            Tilføj til kalender
          </button>
        </div>
        ...
        <div class="warning-note">
          <div class="caution-tape">ADGANG FORBUDT &bull; ADGANG FORBUDT &bull; ADGANG FORBUDT</div>
          <p>
            <strong>STRENG FORTROLIGHED:</strong> Dette arrangement opererer under myndighedernes radar. Del ingen information med udenforstående. Medbring ikke elektroniske enheder der kan spore din lokation.
          </p>
          <p>
            <strong>SIKKERHEDSPROTOKOL:</strong> Hvis du bliver stoppet af myndighederne, benægt alt kendskab til dette arrangement. Vis ikke denne invitation til andre.
          </p>
          <p class="final-message">
            Vi glæder os til at se dig og byder dig velkommen til en aften med spænding, held og muligheden for at vinde <span class="gold-text">millioner!</span>
          </p>
        </div>
...
const addToCalendar = () => {
  ...
  const description = 'Eksklusivt casino-arrangement. Dresscode: Fin påklædning. ' +
